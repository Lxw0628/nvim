  ...
  init = function()
    vim.keymap.set("n", "<Leader>ua", function()
      ...
      if ok then
        ...
        vim.notify(string.format("ultimate-autopair %s", bool2str(not vim.g.ultimate_autopair_enabled)))
      else
        vim.notify("ultimate-autopair not available")
      end
    end, { desc = "Toggle Ultimate Autopair" })
  end,
  opts = {
