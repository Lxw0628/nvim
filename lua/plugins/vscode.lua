    ...
    opts = {
      mappings = {
        n = {
          ...
          ["<Leader>ul"] = "<CMD>call VSCodeNotify('workbench.action.toggleSidebarPosition')<CR>",
          ["<S-h>"] = "<CMD>call VSCodeNotify('workbench.action.previousEditor')<CR>",
          ["<S-l>"] = "<CMD>call VSCodeNotify('workbench.action.nextEditor')<CR>",
        },
        i = {
        }
      },
